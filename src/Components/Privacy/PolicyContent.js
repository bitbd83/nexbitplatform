      ...
      <Grid item lg={8} md={8} sm={12} xs={12}>
        ...
        >
          ...
          <p className={classes.Content}>
            This privacy policy ("Policy") describes how Finansify OÜ
            ("Finansify OÜ", "we", "us" or "our") collects, protects and uses
            the personally identifiable information ("Personal Information") you
            ("User", "you" or "your") may provide on the dexfin.com website and
        ...
        >
          ...
          <p className={classes.Content}>
            ...
            include your email address, name, phone number, address, bank
            information, or other Personal Information. You can choose not to
        ...
        >
          ...
          <p className={classes.Content}>
            ...
            transactions; send newsletters; send notification emails such as
        ...
        <Grid
          ...
          style={{ backgroundColor: 'white' }}
        >
          <h3 className={classes.Heading}>Information transfer and storage</h3>
          <p className={classes.Content}>
        ...
        <Grid
          ...
          style={{ backgroundColor: 'white' }}
        >
          <h3 className={classes.Heading}>The rights of users</h3>
          <p className={classes.Content}>
        ...
        <Grid
          ...
          style={{ backgroundColor: 'white' }}
        >
          <h3 className={classes.Heading}>The right to object to processing</h3>
          <p className={classes.Content}>
        ...
        <Grid
          ...
          style={{ backgroundColor: 'white' }}
        >
          <h3 className={classes.Heading}>How to exercise these rights</h3>
          <p className={classes.Content}>
        ...
        >
          ...
          <p className={classes.Content}>
            ...
            protective as this Privacy Policy. We suggest that you review their
        ...
        <Grid
          ...
          style={{ backgroundColor: 'white' }}
        >
          <h3 className={classes.Heading}>Privacy of children</h3>
          <p className={classes.Content}>
        ...
        <Grid
          ...
          style={{ backgroundColor: 'white' }}
        >
          <h3 className={classes.Heading}>Newsletters</h3>
          <p className={classes.Content}>
        ...
        <Grid
          ...
          style={{ backgroundColor: 'white' }}
        >
          <h3 className={classes.Heading}>Do Not Track signals</h3>
          <p className={classes.Content}>
        ...
        <Grid
          ...
          style={{ backgroundColor: 'white' }}
        >
          <h3 className={classes.Heading}>Affiliates</h3>
          <p className={classes.Content}>
        ...
        <Grid
          ...
          style={{ backgroundColor: 'white' }}
        >
          <h3 className={classes.Heading}>Data breach</h3>
          <p className={classes.Content}>
        ...
        <Grid
          ...
          style={{ backgroundColor: 'white' }}
        >
          <h3 className={classes.Heading}>Legal disclosure</h3>
          <p className={classes.Content}>
        ...
        <Grid
          ...
          style={{ backgroundColor: 'white' }}
        >
          <h3 className={classes.Heading}>Acceptance of this policy</h3>
          <p className={classes.Content}>
